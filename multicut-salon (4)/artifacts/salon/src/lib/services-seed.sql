...
('Head Wash', 'head-wash', 'Hair Wash & Head Massage', 20, 15, 'Thorough cleansing wash for a fresh scalp.', 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=600&q=80', false, 6),
('Head Massage – Olive Oil', 'head-massage-olive-oil', 'Hair Wash & Head Massage', 150, 30, 'Deeply relaxing scalp massage with warm olive oil.', 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=600&q=80', false, 7),
('Head Massage – Almond Oil', 'head-massage-almond-oil', 'Hair Wash & Head Massage', 100, 30, 'Nourishing almond oil massage to strengthen roots.', 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=600&q=80', false, 8),
('Head Steam', 'head-steam', 'Hair Wash & Head Massage', 50, 15, 'Steam therapy to open pores and boost scalp health.', 'https://images.unsplash.com/photo-1562322140-8baeececf3df?w=600&q=80', false, 9),
...
('Hair Keratin – Short to Medium', 'keratin-short', 'Hair Treatment', 1000, 120, 'Keratin treatment for silky smooth short to medium hair.', 'https://images.unsplash.com/photo-1492106087820-71f1a00d2b11?w=600&q=80', true, 26),
...
('Face Bleach', 'face-bleach', 'Face Care', 250, 20, 'Skin-brightening face bleach for a radiant look.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 43),
('Face D-Tan – O3+', 'face-dtan-o3plus', 'Face Care', 200, 20, 'O3+ D-Tan pack to reverse sun damage and brighten skin.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 44),
('Face D-Tan – Sara', 'face-dtan-sara', 'Face Care', 150, 20, 'Sara D-Tan for an even, refreshed complexion.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 45),
('Back Neck D-Tan', 'back-neck-dtan', 'Face Care', 100, 15, 'Targeted D-Tan treatment for the back of the neck.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 46),
('Face Scrub – O3+', 'face-scrub-o3plus', 'Face Care', 250, 20, 'O3+ exfoliating scrub for smoother, cleaner skin.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 47),
('Face Scrub – Lotus', 'face-scrub-lotus', 'Face Care', 200, 20, 'Gentle Lotus scrub to remove dead skin and impurities.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 48),
('Face Scrub – Oxy', 'face-scrub-oxy', 'Face Care', 150, 15, 'Oxygen-boosting scrub for vibrant, refreshed skin.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 49),
('Face Scrub – Kanpeki', 'face-scrub-kanpeki', 'Face Care', 250, 20, 'Kanpeki scrub for deep exfoliation and pore refinement.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 50),
('Face Cleansing – Lotus', 'face-cleansing-lotus', 'Face Care', 200, 20, 'Lotus cleansing ritual for soft, hydrated skin.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 51),
('Face Cleansing – O3+', 'face-cleansing-o3plus', 'Face Care', 250, 20, 'Deep O3+ cleansing for pore clarity and radiance.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 52),
('Face Cleansing – Kanpeki', 'face-cleansing-kanpeki', 'Face Care', 250, 20, 'Kanpeki cleansing for a flawless, balanced complexion.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 53),
('Face Cleansing – Oxy', 'face-cleansing-oxy', 'Face Care', 150, 15, 'Quick Oxy cleansing to remove impurities and refresh skin.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 54),
('Face Steam', 'face-steam', 'Face Care', 50, 10, 'Soothing face steam to open pores and prep skin.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&q=80', false, 55),
